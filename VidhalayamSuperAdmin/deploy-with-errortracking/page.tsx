...
export default function SchoolsPage() {
  ...
  const createSchool = async () => {
    ...
    setSaving(true);
    try {
      // Upload logo to Firebase Storage first if provided
      let logoUrl = "";
      ...
      const res = await fetch(`${apiUrl}/api/super/schools/create`, {
        ...
        body: JSON.stringify({
          ...
          principalPassword: "School@123",   // default, principal should change on first login
      ...
      const school_id   = data.schoolId   || data.school_id   || "";
      ...
      alert("Onboarding failed due to a network error. Please check your connection and try again.");
    } finally {
      setSaving(false);
    }
  };
      ...
      {showModal && (
        <Modal title="🏫 Onboard New School" onClose={resetModal}>
            ...
            {activeTab === "branding" && <>
              <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3">
                ...
                <div className="text-[11px] text-blue-600 mt-1">
                  This logo and color appear on the <strong>splash screen</strong> and <strong>login page</strong> inside the mobile app for every user of this school.
                </div>
              </div>
          ...
          <div className="flex gap-3 justify-end mt-5 pt-4 border-t border-slate-100">
            ...
            <Btn variant="gold" onClick={createSchool} disabled={saving || !form.school_name || !form.village}>
